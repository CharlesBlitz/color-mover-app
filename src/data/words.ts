// Common five-letter English words for the Wordle-style game
export const ANSWER_WORDS = [
  'apple', 'beach', 'chair', 'dance', 'eagle', 'flame', 'grape', 'house',
  'ivory', 'juice', 'knife', 'lemon', 'mouse', 'night', 'ocean', 'piano',
  'queen', 'river', 'snake', 'tiger', 'uncle', 'voice', 'water', 'youth',
  'zebra', 'bread', 'cloud', 'dream', 'earth', 'faith', 'globe', 'heart',
  'image', 'jolly', 'kneel', 'light', 'music', 'novel', 'olive', 'peace',
  'quiet', 'royal', 'smile', 'trust', 'unity', 'vivid', 'whale', 'yummy',
  'baker', 'candy', 'daisy', 'fairy', 'ghost', 'honey', 'index', 'jewel',
  'kayak', 'lunar', 'mango', 'noble', 'opera', 'pearl', 'quack', 'radar',
  'solar', 'topic', 'ultra', 'vapor', 'wheat', 'yield', 'zesty', 'bliss',
  'crisp', 'dwell', 'ember', 'frost', 'gleam', 'hover', 'ionic', 'jumpy',
  'knack', 'liver', 'mirth', 'nudge', 'oasis', 'plumb', 'quilt', 'ridge',
  'swift', 'thorn', 'usher', 'vigor', 'waltz', 'xenon', 'young', 'zilch',
];
...
export const VALID_WORDS = new Set([
  ...
  'ought', 'paint', 'panel', 'paper', 'party', 'peace', 'peter', 'phase',
